...
def download_youtube_to_mp3(url, output_path):
    try:
        ...
        ydl_opts = {
            ...
            'quiet': True,
            'noplaylist': True,
            'ffmpeg_location': r'C:\Users\66940\AppData\Local\Microsoft\WinGet\Packages\Gyan.FFmpeg_Microsoft.Winget.Source_8wekyb3d8bbwe\ffmpeg-7.1-full_build\bin\ffmpeg.exe',
        }
